...
| **Status** | ✅ ALL PASSED |
| **Version** | v1.7.13 |
| **Date** | 2026-05-12 13:41:37 UTC |
| **Platform** | Python 3.10.12 / Linux 5.15.0-177-generic x86_64 |
| **Results** | 177 passed  / 1 skipped in 8.10s |
| **Version Check** | ✅ OK |
...
tests/test_audit.py::test_cleanup_uses_audit_retention 2026-05-12 21:41:40 [info     ] No archives to clean up        retention_days=1095
2026-05-12 21:41:40 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-05-12 21:41:40 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
2026-05-12 21:41:40 [info     ] No archives to clean up        retention_days=1095
2026-05-12 21:41:40 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
tests/test_audit.py::test_cleanup_audit_no_config 2026-05-12 21:41:40 [info     ] No archives to clean up        retention_days=1095
2026-05-12 21:41:40 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-05-12 21:41:40 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
...
tests/test_db_rebuild.py::test_rebuild_dry_run 2026-05-12T13:41:43.820873Z [info     ] Would insert                   path=/tmp/tmpm_k0n9e7/archives/server1/2026/01/test.json.gz server=test time_from=2026-01-01T00:00:00Z
PASSED
...
tests/test_integration.py::test_archive_write_read_integrity 2026-05-12T13:41:45.669477Z [info     ] Archive written                messages=50 path=/tmp/tmp3_ooxxzi/test/stream1/2026/01/01/test_stream1_20260101T000000Z_20260101T010000Z_001.json.gz size_mb=0.00
PASSED
...
tests/test_storage_ownership.py::test_fix_dir_ownership_as_root 2026-05-12T13:41:45.935548Z [warning  ] Fixing directory ownership     new_owner=jt-glogarch path=/tmp/tmphnq2bv7d/archives/log4
PASSED
...
======================== 177 passed, 1 skipped in 8.10s ========================
```

## Version Check

```
Canonical version: 1.7.13
OK: version '1.7.13' has exactly one source of truth.
```

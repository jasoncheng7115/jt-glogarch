...
| **Status** | ✅ ALL PASSED |
| **Version** | v1.13.12 |
| **Date** | 2026-07-12 09:22:08 UTC |
| **Platform** | Python 3.10.12 / Linux 5.15.0-179-generic x86_64 |
| **Results** | 260 passed  / 1 skipped in 30.56s |
| **Version Check** | ✅ OK |
...
tests/test_audit.py::test_cleanup_uses_audit_retention 2026-07-12 17:22:11 [info     ] No archives to clean up        retention_days=1095
2026-07-12 17:22:11 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-07-12 17:22:11 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
2026-07-12 17:22:11 [info     ] No archives to clean up        retention_days=1095
2026-07-12 17:22:11 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
tests/test_audit.py::test_cleanup_audit_no_config 2026-07-12 17:22:12 [info     ] No archives to clean up        retention_days=1095
2026-07-12 17:22:12 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-07-12 17:22:12 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
...
tests/test_db_rebuild.py::test_rebuild_dry_run 2026-07-12T09:22:15.840491Z [info     ] Would insert                   path=/tmp/tmp4s6_mc4q/archives/server1/2026/01/test.json.gz server=test time_from=2026-01-01T00:00:00Z
PASSED
...
tests/test_export_pagination.py::test_deep_pagination_no_same_ms_loss_or_dup 2026-07-12T09:22:16.476899Z [info     ] Total messages to fetch        total=6
2026-07-12T09:22:16.477389Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=4 new_from='2024-01-01 00:00:00.003000' old_from='2024-01-01 00:00:00'
PASSED
tests/test_export_pagination.py::test_deep_pagination_multiple_windows 2026-07-12T09:22:16.481040Z [info     ] Total messages to fetch        total=30
2026-07-12T09:22:16.482168Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=6 new_from='2024-01-01 00:00:00.005000' old_from='2024-01-01 00:00:00'
2026-07-12T09:22:16.483258Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=11 new_from='2024-01-01 00:00:00.010000' old_from='2024-01-01 00:00:00.005000'
2026-07-12T09:22:16.484315Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=16 new_from='2024-01-01 00:00:00.015000' old_from='2024-01-01 00:00:00.010000'
2026-07-12T09:22:16.485333Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=21 new_from='2024-01-01 00:00:00.020000' old_from='2024-01-01 00:00:00.015000'
2026-07-12T09:22:16.486315Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=26 new_from='2024-01-01 00:00:00.025000' old_from='2024-01-01 00:00:00.020000'
PASSED
tests/test_export_pagination.py::test_pagination_raises_on_unsplittable_ms 2026-07-12T09:22:16.490367Z [info     ] Total messages to fetch        total=10
PASSED
...
tests/test_export_pagination.py::test_transient_5xx_fails_over_to_next_host 2026-07-12T09:22:16.503461Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=1 status=503 wait=1
2026-07-12T09:22:16.505817Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=2 status=503 wait=2
2026-07-12T09:22:16.507214Z [warning  ] Transient errors exhausted, failing over to next host host=http://host0:9200 status=503
2026-07-12T09:22:16.508588Z [info     ] Failover to host               host=http://host1:9200
PASSED
tests/test_export_pagination.py::test_all_hosts_transient_raises 2026-07-12T09:22:16.516104Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=1 status=503 wait=1
2026-07-12T09:22:16.517460Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=2 status=503 wait=2
2026-07-12T09:22:16.517669Z [warning  ] Transient errors exhausted, failing over to next host host=http://host0:9200 status=503
2026-07-12T09:22:16.517795Z [warning  ] Transient error, retrying      host=http://host1:9200 retry=1 status=503 wait=1
2026-07-12T09:22:16.517944Z [warning  ] Transient error, retrying      host=http://host1:9200 retry=2 status=503 wait=2
2026-07-12T09:22:16.518076Z [warning  ] Transient errors exhausted, failing over to next host host=http://host1:9200 status=503
PASSED
...
tests/test_health_guard.py::test_pause_then_resume 2026-07-12T09:22:16.755070Z [warning  ] export paused — Graylog backpressure signals=['JVM heap 95%（超過硬上限 90%）']
2026-07-12T09:22:16.755332Z [info     ] export resumed — backpressure cleared waited_sec=1
PASSED
tests/test_health_guard.py::test_pause_times_out_and_raises 2026-07-12T09:22:16.758164Z [warning  ] export paused — Graylog backpressure signals=['JVM heap 99%（超過硬上限 90%）']
2026-07-12T09:22:16.758384Z [error    ] export stopped — backpressure did not clear signals=['JVM heap 99%（超過硬上限 90%）'] waited_sec=60
PASSED
...
tests/test_integration.py::test_archive_write_read_integrity 2026-07-12T09:22:17.969682Z [info     ] Archive written                messages=50 path=/tmp/tmplg1q7wvp/test/stream1/2026/01/01/test_stream1_20260101T000000Z_20260101T010000Z_001.json.gz size_mb=0.00
PASSED
...
tests/test_integrity.py::test_verifier_flags_tampered 2026-07-12T09:22:18.985960Z [info     ] Verification started           total_archives=1
2026-07-12T09:22:18.987094Z [error    ] TAMPERED archive (HMAC mismatch) archive_id=1 path=/tmp/pytest-of-root/pytest-144/test_verifier_flags_tampered0/a.json.gz
2026-07-12T09:22:18.994892Z [info     ] Verification completed         corrupted=0 missing=0 orphans=0 tampered=1 total=1 valid=0
PASSED
...
tests/test_storage_ownership.py::test_fix_dir_ownership_as_root 2026-07-12T09:22:39.249866Z [warning  ] Fixing directory ownership     new_owner=jt-glogarch path=/tmp/tmp0tunqzuq/archives/log4
PASSED
...
======================= 260 passed, 1 skipped in 30.56s ========================
```

## Version Check

```
Canonical version: 1.13.12
OK: version '1.13.12' has exactly one source of truth.
```

...
| **Status** | ✅ ALL PASSED |
| **Version** | v1.12.4 |
| **Date** | 2026-07-09 07:59:41 UTC |
| **Platform** | Python 3.10.12 / Linux 5.15.0-179-generic x86_64 |
| **Results** | 259 passed  / 1 skipped in 18.32s |
| **Version Check** | ✅ OK |
...
tests/test_audit.py::test_cleanup_uses_audit_retention 2026-07-09 15:59:43 [info     ] No archives to clean up        retention_days=1095
2026-07-09 15:59:43 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-07-09 15:59:43 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
2026-07-09 15:59:43 [info     ] No archives to clean up        retention_days=1095
2026-07-09 15:59:43 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
tests/test_audit.py::test_cleanup_audit_no_config 2026-07-09 15:59:43 [info     ] No archives to clean up        retention_days=1095
2026-07-09 15:59:43 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-07-09 15:59:43 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
...
tests/test_db_rebuild.py::test_rebuild_dry_run 2026-07-09T07:59:47.549398Z [info     ] Would insert                   path=/tmp/tmp84bappbc/archives/server1/2026/01/test.json.gz server=test time_from=2026-01-01T00:00:00Z
PASSED
...
tests/test_export_pagination.py::test_deep_pagination_no_same_ms_loss_or_dup 2026-07-09T07:59:48.228447Z [info     ] Total messages to fetch        total=6
2026-07-09T07:59:48.228949Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=4 new_from='2024-01-01 00:00:00.003000' old_from='2024-01-01 00:00:00'
PASSED
tests/test_export_pagination.py::test_deep_pagination_multiple_windows 2026-07-09T07:59:48.232239Z [info     ] Total messages to fetch        total=30
2026-07-09T07:59:48.233278Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=6 new_from='2024-01-01 00:00:00.005000' old_from='2024-01-01 00:00:00'
2026-07-09T07:59:48.234282Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=11 new_from='2024-01-01 00:00:00.010000' old_from='2024-01-01 00:00:00.005000'
2026-07-09T07:59:48.235621Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=16 new_from='2024-01-01 00:00:00.015000' old_from='2024-01-01 00:00:00.010000'
2026-07-09T07:59:48.237287Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=21 new_from='2024-01-01 00:00:00.020000' old_from='2024-01-01 00:00:00.015000'
2026-07-09T07:59:48.238371Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=26 new_from='2024-01-01 00:00:00.025000' old_from='2024-01-01 00:00:00.020000'
PASSED
tests/test_export_pagination.py::test_pagination_raises_on_unsplittable_ms 2026-07-09T07:59:48.242340Z [info     ] Total messages to fetch        total=10
PASSED
...
tests/test_export_pagination.py::test_transient_5xx_fails_over_to_next_host 2026-07-09T07:59:48.256279Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=1 status=503 wait=1
2026-07-09T07:59:48.259187Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=2 status=503 wait=2
2026-07-09T07:59:48.260755Z [warning  ] Transient errors exhausted, failing over to next host host=http://host0:9200 status=503
2026-07-09T07:59:48.262231Z [info     ] Failover to host               host=http://host1:9200
PASSED
tests/test_export_pagination.py::test_all_hosts_transient_raises 2026-07-09T07:59:48.269537Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=1 status=503 wait=1
2026-07-09T07:59:48.270749Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=2 status=503 wait=2
2026-07-09T07:59:48.270931Z [warning  ] Transient errors exhausted, failing over to next host host=http://host0:9200 status=503
2026-07-09T07:59:48.271057Z [warning  ] Transient error, retrying      host=http://host1:9200 retry=1 status=503 wait=1
2026-07-09T07:59:48.271192Z [warning  ] Transient error, retrying      host=http://host1:9200 retry=2 status=503 wait=2
2026-07-09T07:59:48.271349Z [warning  ] Transient errors exhausted, failing over to next host host=http://host1:9200 status=503
PASSED
...
tests/test_health_guard.py::test_pause_then_resume 2026-07-09T07:59:48.544696Z [warning  ] export paused — Graylog backpressure signals=['JVM heap 95%（超過硬上限 90%）']
2026-07-09T07:59:48.544909Z [info     ] export resumed — backpressure cleared waited_sec=1
PASSED
tests/test_health_guard.py::test_pause_times_out_and_raises 2026-07-09T07:59:48.547656Z [warning  ] export paused — Graylog backpressure signals=['JVM heap 99%（超過硬上限 90%）']
2026-07-09T07:59:48.547826Z [error    ] export stopped — backpressure did not clear signals=['JVM heap 99%（超過硬上限 90%）'] waited_sec=60
PASSED
...
tests/test_integration.py::test_archive_write_read_integrity 2026-07-09T07:59:49.965835Z [info     ] Archive written                messages=50 path=/tmp/tmplux8qtjp/test/stream1/2026/01/01/test_stream1_20260101T000000Z_20260101T010000Z_001.json.gz size_mb=0.00
PASSED
...
tests/test_integrity.py::test_verifier_flags_tampered 2026-07-09T07:59:51.009459Z [info     ] Verification started           total_archives=1
2026-07-09T07:59:51.010294Z [error    ] TAMPERED archive (HMAC mismatch) archive_id=1 path=/tmp/pytest-of-root/pytest-101/test_verifier_flags_tampered0/a.json.gz
2026-07-09T07:59:51.017679Z [info     ] Verification completed         corrupted=0 missing=0 orphans=0 tampered=1 total=1 valid=0
PASSED
...
tests/test_storage_ownership.py::test_fix_dir_ownership_as_root 2026-07-09T07:59:59.488198Z [warning  ] Fixing directory ownership     new_owner=jt-glogarch path=/tmp/tmpjad54mx1/archives/log4
PASSED
...
======================= 259 passed, 1 skipped in 18.32s ========================
```

## Version Check

```
Canonical version: 1.12.4
OK: version '1.12.4' has exactly one source of truth.
```
